<template>
  ...
  <div class="bg-special">
    <div class="center">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-emoji-sunglasses-fill element" viewBox="0 0 16 16">
