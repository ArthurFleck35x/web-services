    ...
    <main>
        <section>
            <div class="section">
                <div class="center">
                    ...
                    <p>
                        We are four students who created Uniplace – a platform where anyone can buy and sell. Whether it’s digital in-game items or real-world products, Uniplace makes trading easy, secure, and efficient. Our goal is to build a professional marketplace that is open to everyone and provides seamless access to all kinds of products.</p>
                    <p>Uniplace – your place for limitless trading.</p>
                </div>
            </div>
        </section>
        ...
        <section>
            <div>
                ...
                <p>Digital trading is evolving rapidly – and we are at the forefront. With innovative technologies and a user-friendly platform, we are creating new opportunities to trade digital assets securely, quickly, and efficiently. Our vision: a limitless, transparent, and accessible trading environment for everyone.</p>
